...
const Signup = () => {
    ...
    const signUpForm = () => (
        <form>
            ...
            <button onClick={handleSubmit} type='submit' className="btn btn-primary">Зарегистрироваться</button>
    ...
    return (
        <Layout title='Регистрация' description="" className='container col-md-8 offset-md-2'>
            {showSuccess()}
            {redirectUser()}
            {showError()}
            {signUpForm()}
